...
export const STATE_KEYS = {
  ...
  askSlackThread: (id: string) => `ask-slack-thread-${id}`,
  askSlackComment: (id: string) => `ask-slack-comment-${id}`,
  notificationSent: (eventType: string, entityId: string) => `notification-sent-${eventType}-${entityId}`,
